...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("platform_fee_idr >= 0", name="ck_payment_platform_fee_non_negative"),
        sa.CheckConstraint("creator_net_idr >= 0", name="ck_payment_creator_net_non_negative"),
        sa.CheckConstraint(
